...
var url = "".concat("wss://chat-backend.cemp2703.repl.co", "/ws");
/**
 * @type {WebSocket}
 */
...
btnLogin.addEventListener("click", function () {
  socket = new WebSocket(url); // handle incoming messages
  ...
  socket.onclose = function (event) {
    return console.log("Closed ".concat(event.code));
  ...
  function updateNewMessage(data) {
    ...
    messageElem.textContent = "".concat(data.payload.nick, ": ").concat(data.payload.message);
  ...
  function updateNickList(data) {
    ...
    var _iterator = _createForOfIteratorHelper(data.payload.nicks),
        _step;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40759" + '/');
